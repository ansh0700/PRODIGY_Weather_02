...
const cloudyIcon = createWeatherImg("cloud-icon.png", "clouds");
const rainIcon = createWeatherImg("rain-icon.png", "rain");
const sunIcon = createWeatherImg("sun-icon.png", "sun");
const windIcon = createWeatherImg("wind-icon.png", "wind");
const stormIcon = createWeatherImg("storm-icon.png", "storm");
const snowIcon = createWeatherImg("snow-icon.png", "snow");
...
const fogIcon = createWeatherImg("fog-icon.png");

//Creating images for sunrise and sunset.
const sunriseIcon = createWeatherImg("sunrise-icon.png", "sunrise");
const sunsetIcon = createWeatherImg("sunset-icon.png", "sunset");
